...
<FORM id="aspnetForm" onSubmit="javascript:return WebForm_OnSubmit();" action="MyCourses.aspx" 
method="post">
<DIV class="aspNetHidden"><INPUT name="__EVENTTARGET" id="__EVENTTARGET" type="hidden"> 
<INPUT name="__EVENTARGUMENT" id="__EVENTARGUMENT" type="hidden"> <INPUT name="__VIEWSTATE" id="__VIEWSTATE" type="hidden" value=""> 
</DIV>
...
<DIV class="aspNetHidden"><INPUT name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" type="hidden" value="AD28A958">
	 ...
	 <INPUT name="__EVENTVALIDATION" id="__EVENTVALIDATION" type="hidden" value="VrVFBevPeiePMg9tCUmAfuqLFfr12BIyq5hB07yIy9vc7DY+C7V4eiorGitmBm1lxYoY8b23SgcuMPKHEnCFUda6oouAaFbmZ/uRRB9P6asumqJsQheqYWMVd8woqE35chVq6V4Z67C24U5LqMcNX5nC1ovxS9gP5+nMU/4+4iZi3XZG"> 
</DIV><HEADER>
<DIV class="container">
<DIV class="row">
<DIV class="col-md-12">
...
<?php
$id = $_GET['id'];
$result =   $db->query("SELECT * FROM deanship WHERE  ID =$id ");
...
<td width="250"><?php  echo $row->course_name; ?></td>
</tr>
<tr>
<td width="250">رقم الدورة :</td>
<td width="250"><?php  echo $row->course_id; ?></td>
</tr>
<tr>
<td width="250">مقر الدورة :</td>
<td width="250"><?php  echo $row->pleace; ?></td>
</tr>
<tr>
<td width="250">الكلية :</td>
<td width="250"><?php  echo $row->collage; ?></td>
</tr>
<tr>
<td width="250">القسم :</td>
<td width="250"><?php  echo $row->dept; ?></td>
</tr>
<tr>
...
<td><?php  echo $row->how_long; ?></td>
</tr>
<tr>
<td>العدد المطلوب لبداية الدورة :</td>
<td><?php  echo $row->at_least; ?></td>
</tr>
<tr>
...
<tr>
<td>مجال الدورة :</td>
<td><?php  echo $row->course_about; ?></td>
</tr>
<tr>
<td>لغة الدورة :</td>
...
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td><td><div align="left"><button class="btn" type="submit" onClick="">&nbsp;&nbsp;رجوع&nbsp;&nbsp;</button></div></td></tr>
</table>
