...
<!-- Start Body --> 
<form id="" method="POST" action="insert5.php">
...
<td width="250"><input class="css-input" type="text" size="20" name="collage" id="collage" /></td>
</tr>
<tr>
...
<tr>
<td>تحميل الصور :</td>
<td><input class="css-input" type="file" size="20" value="" name="img" id="img"></td>
</tr>
<tr><td>&nbsp;</td><td>&nbsp;</td></tr>
<tr><td>&nbsp;</td><td><div align="left"><button class="btn" type="submit" onClick="">&nbsp;&nbsp;حـفـظ&nbsp;&nbsp;</button></div></td></tr>
</table>
</div>
</form>   
<!-- End Body -->
